...
use Ticket\Shared\Domain\Entity\EntityService;
...
abstract class BaseRepository implements RepositoryInterface
{
     ...
     *
     * @var Builder|BuilderQuery|null
     */
    protected BuilderQuery|null|Builder $builder;
     ...
     */
    public function getBuilder(): Builder|BuilderQuery
    {
     ...
     */
    public function setBuilder(Builder|BuilderQuery $builder): void
    {
